...
var ProjectRepositoryFiles = function (_BaseModel) {
  _inherits(ProjectRepositoryFiles, _BaseModel);

  function ProjectRepositoryFiles() {
    _classCallCheck(this, ProjectRepositoryFiles);

    return _possibleConstructorReturn(this, (ProjectRepositoryFiles.__proto__ || Object.getPrototypeOf(ProjectRepositoryFiles)).apply(this, arguments));
  }

  _createClass(ProjectRepositoryFiles, [{
    key: 'create',
