...
var ProjectRunners = function (_BaseModel) {
  _inherits(ProjectRunners, _BaseModel);

  function ProjectRunners() {
    _classCallCheck(this, ProjectRunners);

    return _possibleConstructorReturn(this, (ProjectRunners.__proto__ || Object.getPrototypeOf(ProjectRunners)).apply(this, arguments));
  }

  _createClass(ProjectRunners, [{
    key: 'all',
