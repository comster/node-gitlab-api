...
var ProjectRepositoryBranches = function (_BaseModel) {
  _inherits(ProjectRepositoryBranches, _BaseModel);

  function ProjectRepositoryBranches() {
    _classCallCheck(this, ProjectRepositoryBranches);

    return _possibleConstructorReturn(this, (ProjectRepositoryBranches.__proto__ || Object.getPrototypeOf(ProjectRepositoryBranches)).apply(this, arguments));
  }

  _createClass(ProjectRepositoryBranches, [{
    key: 'all',
    ...
    value: function create(projectId, branchName, ref) {
      ...
      return this.post('projects/' + pId + '/repository/branches', { branch: branchName, ref: ref });
    }
  }, {
    key: 'protect',
